...
API_ID = int(environ.get('API_ID', '27651242'))
API_HASH = environ.get('API_HASH', '0a30293ba6e1eb156b5c475f115fde4c')
BOT_TOKEN = environ.get('BOT_TOKEN', '8321069137:AAE8OjZmoq56LIJCZHUvpkSByf1AgkfdPNM')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5305202582').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002046594420').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://devaraju:devaraju@cluster0.twqonzs.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002745994682')
